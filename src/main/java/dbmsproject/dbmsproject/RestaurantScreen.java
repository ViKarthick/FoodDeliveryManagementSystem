...
public class RestaurantScreen extends javax.swing.JFrame {
     ...
     */
    public RestaurantScreen(String restaurantId) {
    ...
    newproject22 obj = new newproject22(restaurantId);
obj.setVisible(true);
...
// TODO add your handling code here:
     ...
     */
    public static void main(String restaurantId) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RestaurantScreen(restaurantId).setVisible(true);
            }
        });
    }
